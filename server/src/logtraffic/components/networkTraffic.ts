...
const NETWORK_TRAFFIC_SHELL = path.resolve(__dirname, '../../source/sh/network-traffic.sh')
...
export const logTraffic = async (logFilePath: string) => {
  ...
  await writeTrafficDataToFile(logFilePath, formated)
}
